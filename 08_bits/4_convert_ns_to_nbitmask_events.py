    ...
    with open(file_path, mode='r') as file:
        for line in file:
            ...
            if line:  # Skip empty lines
                # Get only decimal part after the dot
                decimal_part = line.split('.')[1]
                nanoseconds.append(int(decimal_part))
...
if __name__ == "__main__":
    # file_path = '08_bits/data/CERN-01_event1221.csv'
    file_path = '08_bits/data/CERN-02_sec1221.csv'
    ...
    output_file_path = input_path.parent / f"{input_path.stem}_nbit{n_bits}{input_path.suffix}"
